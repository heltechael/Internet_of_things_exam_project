...
import eventlet # use this for asynchronous calls to/from client
from flask import Flask, render_template, make_response, g, request, send_file
from flask_mqtt import Mqtt
from flask_cors import CORS
from flask_socketio import SocketIO
from flask_bootstrap import Bootstrap # use this for frontend 
...
socketio.run(app, host=host_local_network if is_raspberry_pi() else host_local_computer, port=9000)
